...
export default class Main extends Component {
    ...
    render() {
        ...
        div > < small > { user.email } < /small></div >
            ...
            address >
            <
            strong > { user.address.street } < /strong><br / > { user.address.suite } < br / > { user.address.city } < br / > { user.address.zipcode } < br / >
            <
        ...
        return ( <
            ...
            Col class = "col-sm-6" >
            <
            Collapse isOpened = { users && users.length > 0 }
            springConfig = {
                ...
                Col class = "col-sm-6" >
                <
                Collapse isOpened = {!!userMetadata }
                springConfig = {
